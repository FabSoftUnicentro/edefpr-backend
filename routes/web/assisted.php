...
Route::group(['middleware' => ['permission:register-assisted']], function () {
    ...
    Route::post('/{assisted}/assets', 'Asset\AssetStore')->name('assisteds.asset.store');
});
...
Route::group(['middleware' => ['permission:update-assisted']], function () {
    ...
    Route::get('/{assisted}/asset/{asset}/edit', 'Asset\AssetEdit')->name('assisteds.asset.edit');
    Route::put('/{assisted}/asset/{asset}', 'Asset\AssetUpdate')->name('assisteds.asset.update');
});
...
Route::group(['middleware' => ['permission:read-assisted']], function () {
    ...
    Route::get('/{assisted}/assets/list', 'Asset\AssetIndex')->name('assisteds.asset.index');
});

Route::group(['middleware' => ['permission:delete-assisted']], function () {
    Route::delete('/{assisted}', 'AssistedDestroy')->name('assisteds.destroy');

    Route::delete('/{assisted}/assets/{asset}', 'Asset\AssetDestroy')->name('assisteds.asset.destroy');
});
